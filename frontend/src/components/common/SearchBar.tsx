...
const SearchBar = forwardRef<HTMLInputElement, SearchBarProps>(
  (props, ref) => {
    const combinedRef = (node: HTMLInputElement | null) => {
      ...
      if (typeof props.inputRef === "function") (props.inputRef as (n: HTMLInputElement | null) => void)(node);
      else if (props.inputRef) (props.inputRef as React.MutableRefObject<HTMLInputElement | null>).current = node;
    };
